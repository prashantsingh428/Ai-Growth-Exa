    ...
    return (
        <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
            ...
            <div className="container mx-auto px-6 max-w-5xl relative z-10 py-12">
                ...
                >
                    <div className="absolute -left-4 top-0 w-1 h-full bg-blue-600 rounded-full hidden md:block"></div>
                    <p className="text-xl md:text-2xl text-gray-700 text-center leading-relaxed max-w-4xl mx-auto">
                        At <span className="font-bold text-blue-600">AI GrowthExa</span>, we help businesses build brands that feel real, purposeful, and unforgettable.
                ...
                <div
                    ...
                    className="relative"
                >
                    <div className="relative p-10 md:p-12 bg-blue-50 border-2 border-blue-600 rounded-2xl shadow-xl">
                        {/* Corner decorations */}
                        <div className="absolute -top-3 -left-3 w-6 h-6 border-l-2 border-t-2 border-blue-600"></div>
                        <div className="absolute -bottom-3 -right-3 w-6 h-6 border-r-2 border-b-2 border-blue-600"></div>
