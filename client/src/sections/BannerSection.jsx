                    ...
                    <div ref={textRef} className="space-y-6">
                        ...
                        <div className="pt-8">
                            <button
                                ...
                                className="px-10 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-500 hover:to-purple-500 text-white font-bold text-xl rounded-full shadow-[0_0_20px_rgba(99,102,241,0.4)] hover:shadow-[0_0_35px_rgba(99,102,241,0.6)] hover:scale-105 transition-all duration-300 transform"
                            >
